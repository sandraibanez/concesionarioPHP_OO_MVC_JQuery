<div id="menu">
    ...
    <div class="settings"></div>
        ...
        <ul>
            <li>
                    <a href="index.php?page=ctrl_home&op=list">
                            <!-- <i class="fa fa-home fa-lg"></i> -->
                            <span class="nav-text" >COCHEECO </span>
                            </span>
                ...
                <li>
                <a href="index.php?page=ctrl_shop&op=list">
                <i class="fa fa-shopping-cart"></i>
                <span class="nav-text">shop</span>
                </a>
                </li>
                <li>
                <a href="index.php?page=ctrl_login&op=list">
                ...
                <span class="nav-text">Conocenos</span>
                </a>
                </li>
                <li>
            ...
            <li>
            <div  class="log_icon" id="des_inf_user">
